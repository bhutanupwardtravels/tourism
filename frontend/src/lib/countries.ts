...
// ISO 3166-1 alpha-2 + E.164 calling codes, sorted alphabetically by name.
export const COUNTRIES: Country[] = [
    ...
    { name: "Dominican Republic", iso2: "DO", dialCode: "+1849" },
...
export function countryName(iso2: string): string | undefined {

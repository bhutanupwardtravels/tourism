...
export function DataTableToolbar<TData>({ table, view, onViewChange }: DataTableToolbarProps<TData>) {
    ...
    return (
        <div className="flex items-center justify-between">
            <div className="flex flex-1 items-center gap-2">
                ...
                />
                {isFiltered && (
                    <Button variant="ghost" size="sm" onClick={() => table.resetColumnFilters()} className="text-black h-9">
                        Reset
                        <X />
                    </Button>
                )}
